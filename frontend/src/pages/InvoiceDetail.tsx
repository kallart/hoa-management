...
const InvoiceDetail = () => {
  ...
  const rawItems = [
    ...
    {
      name: invoice.interest > 0 ? (invoice.isInterestWaived ? 'ดอกเบี้ยยอดค้างชำระ (ได้รับการยกเว้น)' : 'ดอกเบี้ยยอดค้างชำระ') : '',
          ...
          <div id="invoice-print-area" onClick={() => setIsFullscreen(!isFullscreen)} style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              ...
              <div style={{ border: '2px solid #D1D5DB', borderRadius: '12px', padding: '10px 15px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', fontFamily: '"Noto Sans Thai", sans-serif', fontStretch: '68%' }}>
                <div style={{ textAlign: 'center', fontSize: '1.3rem', lineHeight: '1.15', fontVariationSettings: '"wdth" 68, "wght" 400' }}>
                ...
                <div style={{ textAlign: 'center', fontSize: '1.56rem', lineHeight: '1.15', marginTop: '6px', whiteSpace: 'nowrap', fontVariationSettings: '"wdth" 68, "wght" 700' }}>
